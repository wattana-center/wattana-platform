...
import ManageReservations from '@app/components/model/manage/reservations'
import { NextPage } from 'next'
import ROUTESPATH from '@app/config/routes-path'
import React from 'react'
import TopbarMange from '@app/layout/Manage/TopbarMange'

type EMSearchReservationsPageProps = {
  business: BusinessResponseGet
}

const EMSearchReservationsPage: NextPage<EMSearchReservationsPageProps> =
  () => {
    return (
      <>
        <Toolbar />
...
export default withAuthUser<EMSearchReservationsPageProps>({
  whenUnauthedAfterInit: AuthAction.REDIRECT_TO_LOGIN
})(EMSearchReservationsPage)
